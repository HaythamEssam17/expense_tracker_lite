...
import 'package:expense_tracker_lite/features/dashboard/presentation/pages/expense_list_view.dart';
      ...
      body: Stack(
        children: [
          Align(
            ...
            child: SizedBox(
              height: SharedText.screenHeight * 0.55,
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: const BorderRadius.horizontal(
                  left: Radius.circular(AppConstants.radius22),
                  right: Radius.circular(AppConstants.radius22),
                ),
              ),
              child: Column(
                children: [
